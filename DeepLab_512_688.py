...
tf.flags.DEFINE_string("logs_dir", "/home/lenovo/256Gdisk/tainchi/log1120_3/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "/home/lenovo/256Gdisk/juesai/enhance_3/", "path to dataset")
...
def main(argv=None):
    ...
    if FLAGS.mode == "train":
        ...
        for i in range(25):
            ...
            b = new_2017[0:3000, i * 600:i * 600 + 600]
        ...
        tiff.imsave('/home/lenovo/256Gdisk/tainchi/vgg/fo_crf_1120_3.tif', Crf)
        np.save('/home/lenovo/256Gdisk/tainchi/vgg/fo_1120_3.npy', softmax)
        res1 = np.concatenate(tuple(allImg), axis=1).astype(np.uint8)
        tiff.imsave('/home/lenovo/256Gdisk/tainchi/vgg/fo_1120_3.tif', res1)
...
def open_and_close(img):
    ...
    tiff.imsave('/home/lenovo/256Gdisk/tainchi/vgg/fo_open_1120_3.tif', img)
