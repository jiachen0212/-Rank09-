...
tf.flags.DEFINE_string("logs_dir", "log1113/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "enhance1113_4/", "path to dataset")
...
def main(argv=None):
    ...
    if FLAGS.mode == "train":
        ...
        im_2017_list.append(
            np.array([np.array([new_2017[0:4000, 15000:15106, 2] for i in range(3)])]).transpose(0, 2, 3, 1))
        '''
        for i in range(50):
        ...
        #tiff.imsave('/home/lenovo/2Tdisk/Wkyao/_/2017/vgg/crf_vgg_1107.tif', Crf)
        np.save('/home/lenovo/2Tdisk/Wkyao/_/2017/vgg/1113.npy', softmax)  # 保存拼接的Softmax为np
        np.save('/home/lenovo/2Tdisk/Wkyao/FirstSetp/ChenJ/finall/1110/1113.npy', softmax)  #备份
        res1 = np.concatenate(tuple(allImg), axis=1).astype(np.uint8)
        tiff.imsave('/home/lenovo/2Tdisk/Wkyao/_/2017/vgg/1113.tif', res1)
...
def open_and_close(img):
    ...
    tiff.imsave('/home/lenovo/2Tdisk/Wkyao/_/2017/vgg/open_1113.tif', img)
