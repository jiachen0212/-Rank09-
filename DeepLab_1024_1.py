...
tf.flags.DEFINE_string("logs_dir", "logs_deep1030_1024/", "path to logs directory")
...
def main(argv=None):
    ...
    if FLAGS.mode == "train":
        ...
        tiff.imsave('/home/lenovo/2Tdisk/Wkyao/_/2017/crf_build7_1030_23200.tif', Crf)
        ...
        tiff.imsave('/home/lenovo/2Tdisk/Wkyao/_/2017/build7_1030_23200.tif', res1)
