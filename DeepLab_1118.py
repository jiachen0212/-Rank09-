...
import BatchDatsetReader as dataset     # 读.png!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
tf.flags.DEFINE_string("logs_dir", "/home/lenovo/256Gdisk/tainchi/log1118_4/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "/home/lenovo/256Gdisk/tainchi/enhance1118_4/", "path to dataset")
...
FILE_new_2015 = '/home/lenovo/2Tdisk/Wkyao/_/20171105_quarterfinals/quarterfinals_2015.tif'
...
def main(argv=None):
    ...
    image = tf.placeholder(tf.float32, shape=[None, None, None, 1], name="input_image")  # 输入
    ...
    image_options = {'resize': False, 'resize_size': IMAGE_RESIZE}  # 将IMAGE_SIZE大小作为一个batch
    ...
    if FLAGS.mode == "train":
        ...
        global new_2015
        for i in range(25):
            b = new_2017[0:4000, i * 600:i * 600 + 600, 3]     # 训练第四通道的话,测试的时候也要换成第四通道.
        ...
        im_2017_list.append(
            np.array([np.array([new_2017[0:4000, 15000:15106, 3] for i in range(3)])]).transpose(0, 2, 3, 1))
        '''
        for i in range(50):
        ...
        np.save('/home/lenovo/2Tdisk/Wkyao/_/2017/vgg/1116_3.npy', softmax)  # 保存拼接的Softmax为np
        np.save('/home/lenovo/2Tdisk/Wkyao/FirstSetp/ChenJ/finall/1110/1116_3.npy', softmax)
...
def open_and_close(img):
    ...
    tiff.imsave('/home/lenovo/2Tdisk/Wkyao/_/2017/vgg/open_1116_3.tif', img)
