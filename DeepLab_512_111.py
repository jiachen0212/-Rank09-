...
tf.flags.DEFINE_string("logs_dir", "logs_deep1104/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "enhance11.4/", "path to dataset")
    ...
    for i, name in enumerate(layers):
        ...
        if kind == 'conv':
            ...
            if name[4:5] == '5':  # conv5开始使用atrous_conv2d卷积.
                ...
                current = utils.batch_norm_layer(current, FLAGS.mode, scope_bn=name)  # BN处理,并且直接实现了scale.
            else:  # conv1-4
